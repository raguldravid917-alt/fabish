      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-[40px] pt-[40px] pb-[80px]">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-[24px]">
          {displayProducts.map((product) => {
            ...
            return (
              <div key={product._id} className="flex flex-col group w-full col-span-1">
                ...
                <div className="relative overflow-hidden w-full aspect-[533/622] flex items-center justify-center cursor-pointer p-0 bg-[#f4f5eb]">
                  ...
                  <div className="absolute top-[12px] right-[12px] flex flex-col gap-[8px] opacity-100 lg:opacity-0 lg:group-hover:opacity-100 lg:translate-x-4 lg:group-hover:translate-x-0 transition-all duration-300 z-20">
                    <button
                      type="button"
                      onClick={(e) => {
                        e.stopPropagation();
                  ...
                  {!isSoldOut ? (
                    <button
                      ...
                      className="absolute bottom-[16px] lg:bottom-[24px] left-1/2 -translate-x-1/2 w-[110px] lg:w-[120px] h-[36px] lg:h-[40px] bg-[#2f3e10] hover:bg-[#729855] text-white text-[11px] font-bold tracking-[2px] lg:tracking-[3px] uppercase opacity-100 lg:opacity-0 lg:group-hover:opacity-100 lg:translate-y-0 lg:translate-y-2 transition-all duration-300 z-20 border-none cursor-pointer shadow-sm flex items-center justify-center"
                    >
                      ADD CART
                    </button>
                  ) : (
