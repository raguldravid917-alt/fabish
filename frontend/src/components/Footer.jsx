      ...
      >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center w-full gap-[20px] md:gap-0">
          ...
          <div className="flex-1 flex justify-center md:justify-end items-center gap-[16px]">
            ...
            <button
              onClick={scrollToTop}
              className="ml-4 w-[40px] h-[40px] bg-black text-white rounded-full flex items-center justify-center hover:bg-[#8B5A2B] transition-colors cursor-pointer border-none"
