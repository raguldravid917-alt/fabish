...
const FaceCreamBanner = () => {
  return (
    <section className="relative w-full h-[600px] flex items-center overflow-hidden group cursor-pointer bg-[#f5f6ee]">
      ...
      <div className="relative z-10 w-full md:w-[60%] px-8 md:px-20 lg:px-[120px]">
        ...
        <h2 className="text-[40px] md:text-[46px] text-[#111] font-medium tracking-tight mb-5 whitespace-nowrap">
